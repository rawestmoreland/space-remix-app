...
export const loader = async ({ request }: ClientLoaderFunctionArgs) => {
  ...
  queryURL.searchParams.append('search', 'artemis');
...
export default function ArtemisNews() {
  ...
  return (
    <main className='flex-1'>
      <div className='mx-auto mb-8 w-full max-w-6xl px-4 md:px-0'>
        <div className='my-4'>
          <TypographyH1>Artemis Program News</TypographyH1>
        </div>
        <div>
          <TypographyMuted>
            The latest news about Artemis, the NASA program to return humans to
            the moon.
          </TypographyMuted>
        </div>
