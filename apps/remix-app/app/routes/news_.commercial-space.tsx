...
export const loader = async ({ request }: ClientLoaderFunctionArgs) => {
  ...
  queryURL.searchParams.append(
    ...
    'commercial,blue origin,spacex,rocket lab,virgin galactic,sierra space,axiom space,axiom,astra,astra space'
  );
...
export default function CommercialSpaceNews() {
  ...
  return (
    <main className='flex-1'>
      <div className='mx-auto mb-8 w-full max-w-6xl px-4 md:px-0'>
        <div className='my-4'>
          <TypographyH1>Commercial Space News</TypographyH1>
        </div>
        <div>
          <TypographyMuted>
            The latest news about commercial space, including SpaceX, Blue
            Origin, and more.
          </TypographyMuted>
        </div>
